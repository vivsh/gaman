...
/// An unsupported statement (INSERT) produces `ParseError::UnsupportedStatement`.
#[test]
...
/// SQLite parsing segments trigger bodies with internal semicolons before lowering.
#[test]
...
/// Parsing accepts a final DDL statement without a trailing semicolon after segmentation.
#[test]
